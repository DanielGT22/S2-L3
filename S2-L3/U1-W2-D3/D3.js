...
/* ESERCIZIO 5
  Utilizza uno switch statement per inserire uno ad uno gli oggetti dei personaggi di "starWarsCharacters" negl
  i array relativi al colore degli occhi precedentemente creati.
...
else if (shipMass >= 500) {
  console.log("Ship is half loaded");
}
else if (shipMass > 700) {
  console.log("Warning!Ship is over 700");
}
...
*/
let randomElement = Math.ceil(Math.random() * 10)

console.log(starWarsCharacters[randomElement]);
